...
.current {font-size: 170%; color: <?php echo $highlight_font_color ?>}                        /* used to highlight the current item */
...
.current_under {font-size: 105%; color: <?php echo $highlight_font_color ?>}                        /* used to highlight the current item */
.areas_list_core {color: <?php echo $areas_list_color ?>}    
.roomsofarea_list_core {color: <?php echo $roomsofarea_list_color ?>} 
...
h42 {font-size: medium; font-weight: bold; text-decoration: underline; margin-top: 0; margin-bottom: 2em; padding-bottom: 2px}
h43 {display: inline; font-size: large; font-weight: bold; text-decoration: underline; margin-top: 0; margin-bottom: 10px; padding-bottom: 2px}
...
#roomChoiceForm select { font-size: 120%; display: block; float: left; margin: 0 auto}
...
div#dwm_room_choice  {overflow : auto; text-align: center; margin-right: 0 auto; padding: 10em;}

//div#dwm_rooms_list  {float: left; margin-right: 2.0em; border: 3px solid ; border-color: <?php echo $highlight_font_color ?>; padding : 5px}
div#dwm_rooms_list  {float: left; margin-right: 2.0em; box-shadow: 1px 1px 1px 2px rgba(0,0,0,0.4); padding: 4px}


div#dwm_areas_list  {float: left; margin-right: 2.0em; color: <?php echo $areas_list_color ?>}
div#dwm_roomsofarea_list  {float: left; margin-right: 2.0em; color: <?php echo $areas_list_color ?>}
...
#edit_room fieldset.print_admin_sheet {margin-top: 1em}
...
div#print_admin_sheet {float: left; clear: none; width: auto}
...
.form_general a {float: right;text-decoration: underline;margin-left: 1.0em}
...
.edit_entry_handler div#print_admin_sheet {float: left}
.edit_entry_handler #print_admin_sheet form {float: left; margin: 1em 2em 1em 0}
